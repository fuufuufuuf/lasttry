...
const SKILL_PATH = path.join(__dirname, '../skills/banana12/SKILL.md');
...
async function generateBanana12Prompt(anthropicConfig, productDesc, productImgUrl, modelImgUrl) {
  ...
  const res = await fetch(endpoint, {
    ...
    headers: {
      ...
      'HTTP-Referer': 'https://github.com/banana12-pipeline',
      'X-Title': 'Banana12 Pipeline',
    },
    body: JSON.stringify({
  ...
  console.log('[Claude] Banana12 prompt generated');
...
module.exports = { generateBanana12Prompt };
