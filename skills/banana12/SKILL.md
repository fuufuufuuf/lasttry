---
name: banana12
description: Fashion e-commerce 12-grid prompt engineer for Nano Banana (Gemini Flash Image). Accepts two reference images — Image 1 is the product's own photo (ground truth for clothing color, texture, and construction), Image 2 is the completed model photo (ground truth for character, scene, and lighting) — and generates a production-ready prompt for Nano Banana to produce a 4x3 grid (12 frames) including left-side, right-side, and back views. Each image serves its designated role as a separate fidelity anchor, preventing color drift on the clothing and face drift on the model across all 12 frames.
argument-hint: product-image + model-image
user-invokable: true
---

# Banana12 - Model to 12-Grid (Nano Banana Edition)
...
3. **Use only the person in Image 2** as the character for all 12 frames
...
When only the model photo is used, the product's color and texture have already been modified by the scene's lighting, depth of field, and camera angle. Nano Banana reads these as the "truth" and may reproduce the distorted version across all 12 frames.
...
- Image 2 (Character + Scene Reference): The completed model photo. Use this as the
  ...
  in Image 2 is the only person that should appear in all 12 frames.
```
...
- **Image 2** — Completed model photo (the fashion shoot result to be expanded into the 12-grid)
...
2. **Identity Lock is native.** The phrase "Using the exact person from Image 2, maintain identical facial structure, hairstyle, and accessories across all 12 panels" activates built-in character consistency using Image 2 as the anchor.
...
- What is NOT visible in close-ups: list which details are outside frame in Frames 6, 10 so Nano Banana does not hallucinate them
...
**ROW 3 — Multi-Angle Views (Left / Right / Back)**
...
**ROW 4 — Detail and Angle Variants**
...
- Frame 10 (ECU macro) must explicitly reference Image 1 as its source: "reproduce the fabric texture and color exactly as shown in Image 1"
...
- Identical face across all 12 frames — no feature drift between panels
- Same hair, same accessories in every frame — no variation
- Activate with: "Using the exact person from Image 2, maintain identical facial structure, bone structure, interpupillary distance, hairstyle, and accessories across all 12 panels"

### Grid Cohesion
- All 12 frames share one scene — same light source direction, same environment
...
- Hidden in close-ups: [list what won't be visible in Frames 6, 10]
...
Frame 7 (Left Side / 50-85mm | ref: both): [90° left profile, full body, side seam and drape]
Frame 8 (Right Side / 50-85mm | ref: both): [90° right profile, full body, side seam and drape]
Frame 9 (Back View / 50-85mm | ref: both): [180° rear, full body, back construction detail]
Frame 10 (ECU / 100mm macro | ref: **Image 1 primary**): [exact macro element, color/texture truth]
Frame 11 (Low Angle / 35mm | ref: Image 2): [below waist up, drape, silhouette]
Frame 12 (High Angle / 35mm | ref: both): [overhead, shoulder/top layout]
...
hair, skin tone, body type, or pose — into any of the 12 generated frames.
...
The only person who appears in all 12 frames is the person from Image 2.

Using the exact person from Image 2, generate one single image: a 4×3 grid storyboard with
12 frames arranged in 4 rows of 3 columns, clearly separated by thin white lines.

ABSOLUTE PRIORITY — CHARACTER RULE:
The only person in all 12 frames is the exact person from Image 2. Image 1 may contain a
...
accessories from Image 2 across all 12 panels. No facial drift between frames.
...
across all 12 frames even as the scene lighting varies.

SCENE (Image 2 environment — identical across all 12 frames):
...
FRAME 7 — Left Side Full Body (50mm lens, camera at 90° left): [description — full body left profile, side seam and drape visible, garment color as per Image 1]
FRAME 8 — Right Side Full Body (50mm lens, camera at 90° right): [description — full body right profile, mirror of Frame 7]
FRAME 9 — Back View Full Body (50mm lens, camera behind model): [description — full body rear view, back construction, vent, seam detail, garment color as per Image 1]
FRAME 10 — Extreme Close-Up (100mm macro): [description — "reproduce fabric texture and
  color exactly as shown in Image 1 — this frame uses Image 1 as its sole visual reference"]
FRAME 11 — Low Angle (35mm lens, camera below waist): [description]
FRAME 12 — High Angle (35mm lens, camera above): [description]

TECHNICAL REQUIREMENTS:
Photorealistic fashion photography. Consistent cinematic color grading across all 12 frames.
...
Garment color in all 12 frames must match Image 1 — the product reference photo is the
...
- Image 2 (Character + Scene Reference): Western European woman wearing the coat on autumn city sidewalk, golden hour light — this is the only person who appears in all 12 frames
...
- Hidden in close-ups: Lower coat and hem not visible in Frames 6, 10; do not invent details
...
Frame 7 (Left Side / 50mm | ref: both): Full body, camera at 90° left of model. Left profile standing pose. Side seam of coat visible, drape and silhouette from left angle. Camel tan color per Image 1. Copper hair falls naturally. Same autumn sidewalk environment.

Frame 8 (Right Side / 50mm | ref: both): Full body, camera at 90° right of model. Right profile standing pose. Mirror of Frame 7. Side seam, pocket placement (if any), and drape visible from right. Garment color per Image 1.

Frame 9 (Back View / 50mm | ref: both): Full body, camera directly behind model. Rear view showing back panel construction, center seam, vent (if any), shoulder structure from behind, and hem line. Model looking slightly over shoulder for natural pose. Camel tan color per Image 1.

Frame 10 (ECU / 100mm macro | ref: **Image 1 primary**): Macro of double-breasted button panel. One burnished gold button in sharp focus — metal surface and stitching detail. Surrounding wool weave illuminated by raking sidelight. Color and texture reproduced exactly from Image 1 — Image 1 is the sole reference for this frame.

Frame 11 (Low Angle / 35mm | ref: Image 2): Camera below knee level looking up. Coat drapes dramatically from above. Mid-thigh hem against autumn sky and bare branches. Empowering framing.

Frame 12 (High Angle / 35mm | ref: both): Model seated on low stone steps. 45-degree overhead view. Shoulder structure, lapels, all 4 gold buttons visible from above. Golden leaves on steps around her.
...
type — into any of the 12 generated frames. Extract from Image 1 ONLY: garment color, fabric
...
distance, hairstyle, and accessories across all 12 panels using Image 2 as the identity anchor.
...
color is as shown in Image 1. Maintain this color accuracy across all 12 frames even as
...
FRAME 7 — Left Side Full Body (50mm lens, camera at 90° left): Full body left profile.
Model standing naturally, camera positioned directly to her left. Side seam of the coat
clearly visible, showing how the camel tan wool drapes from shoulder to mid-thigh hem.
Structured shoulder line visible in profile. Garment color as per Image 1. Same autumn
sidewalk environment, golden sidelight now illuminating the front of the coat.

FRAME 8 — Right Side Full Body (50mm lens, camera at 90° right): Full body right profile.
Mirror composition of Frame 7. Camera positioned directly to model's right. Side seam,
drape, and silhouette visible from the opposite angle. Any pocket or side detail visible.
Garment color as per Image 1. Warm golden backlight from the left now creates rim lighting.

FRAME 9 — Back View Full Body (50mm lens, camera behind model): Full body rear view.
Camera directly behind the model. Back panel of the coat fully visible — center back seam,
vent (if present), shoulder structure from behind, and clean straight hem at mid-thigh.
Model looking slightly over her right shoulder for a natural pose. Copper hair visible
from behind. Camel tan color per Image 1. Autumn sidewalk stretches ahead of the model.

FRAME 10 — Extreme Close-Up (100mm macro): Tight macro of the coat's double-breasted button
...
FRAME 11 — Low Angle (35mm lens, camera positioned below knee level): Camera looking upward
...
FRAME 12 — High Angle (35mm lens, camera at 45-degree overhead angle): Model seated on low
...
across all 12 frames — no color temperature shift between frames. Accurate depth of field
per shot type: wide DOF for Frames 1–4, 7–9, progressively shallower DOF for Frames 5–6, 10.
All frames share identical light source direction (camera-left) and quality from Image 2.
Garment color in all 12 frames must match Image 1 — the product reference is the color
